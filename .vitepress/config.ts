...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      { text: '第 7 章 Turn Loop 与对话引擎', link: '/chapter-07/turn-loop' },
      { text: '第 8 章 权限系统', link: '/chapter-08/permissions' },
      { text: '第 9 章 钩子系统', link: '/chapter-09/hooks' },
      { text: '第 10 章 会话管理', link: '/chapter-10/session' },
      { text: '第 11 章 协调器', link: '/chapter-11/coordinator' },
      { text: '第 12 章 MCP 协议与插件扩展', link: '/chapter-12/mcp' },
      { text: '第 13 章 测试与质量保障', link: '/chapter-13/testing' },
      { text: '第 14 章 TypeScript vs Python/Rust 三端对比', link: '/chapter-14/comparison' },
      { text: '第 15 章 从 Java 工程师到 Agent 工程师', link: '/chapter-15/mindset' },
      { text: '第 16 章 配置层', link: '/chapter-16/config-layer' },
      { text: '第 17 章 AI-Native 工程工作流', link: '/chapter-17/workflow' },
      { text: '第 18 章 总结与展望', link: '/chapter-18/summary' },
    ],
