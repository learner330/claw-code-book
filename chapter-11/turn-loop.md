# 第7章 Turn Loop 与对话引擎：Conversation Runtime
...
## 7.3 build_assistant_message：流式事件组装
...
| 关键文件 | 核心机制 | 对应章节 |
| --- | --- | --- |
| `rust/crates/runtime/src/conversation.rs` | `ConversationRuntime`、`run_turn`、trait 注入 | 7.1-7.2 |
| `rust/crates/runtime/src/conversation.rs` | `build_assistant_message`、事件组装 | 7.3 |
| `rust/crates/runtime/src/conversation.rs` | `maybe_auto_compact`、`SessionTracer` | 7.4-7.5 |
| `rust/crates/runtime/src/compact.rs` | `compact_session`、`CompactionConfig` | 7.4 |
